...
"""Find Human with BasicAwareness"""
...
class HumanTrackedEventWatcher(object):
    ...
    def on_human_tracked(self, value):
        ...
        if value >= 0:  # found a new person
            ...
            print "The tracked person with ID", value, "is at the position:", \
                "x=", x, "/ y=",  y, "/ z=", z
        if value < 0:
            self.moveHeadCenterAndSetStiffness()
    ...
    def moveHeadCenterAndSetStiffness(self):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="192.168.1.208",
